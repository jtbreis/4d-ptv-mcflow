...
cameras = [1, 2, 3, 4]
folder_path = '/workspaces/4d-ptv-mcflow/raw_data/2025-11-13-ParticleTracking_AboveTTI/Calibration_Before'
...
# %%
calibration.interactively_remove_detected_points(1, 10)
# %%
